...
import { getPostPath } from "../../common/urls.server";
...
function PostListItem({ post }: PostListItemProps) {
  return (
    <Link
      ...
      className="block border-t-2 border-slate-100 p-6 dark:border-slate-800 dark:bg-slate-800 sm:rounded-xl sm:border sm:p-8 sm:shadow-xl"
    >
